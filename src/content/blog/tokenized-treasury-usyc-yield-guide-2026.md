...
level: "intermediate"
draft: false
image: "/og/tokenized-treasury-usyc-yield-guide-2026.png"
---
...
- The number of USYC tokens you hold stays constant
- The price of each token increases daily as yield accrues
- Your account value grows through price appreciation, not new tokens
...
- 7-day annualized APY: ~3.93%
- Underlying: US T-bills + repo/reverse-repo
- Redemption: T+0, 24/7 into USDC
- Management fee: embedded in yield (net figure)
...
- Non-US entity or investor (this is an offshore fund)
- KYC/AML onboarding through Circle/Hashnote
- Institution or qualified investor status in most jurisdictions
- Onboarding contact: customer-support@circle.com
...
3. **OKX institutional**: Similar off-exchange collateral model is being explored. [OKX](https://www.okx.com/join/26575603) has been active in RWA integrations across its institutional suite.
...
| Product | Issuer | AUM (May 2026) | APY | Min. | Model | Who Can Access |
|---|---|---|---|---|---|---|
| USYC | Hashnote/Circle | ~$2.9B | ~3.93%* | No stated min | Price accrual | Non-US institutional |
| BUIDL | BlackRock/Securitize | ~$2.58B | ~3.44%* | $5,000,000 | Rebasing | US qualified purchasers |
| USDY | Ondo Finance | ~$1.88B | ~3.55%* | Varies | Price accrual | Non-US retail |
| BENJI | Franklin Templeton | Top 5 | 4.3-4.6%* | $20 | Rebasing | US retail (app) |
...
- Monthly yield: ~$1,637.50
- Annual yield: ~$19,650
- T+0 redemption available any time

Compare to:
- US money market fund (Vanguard VMFXX): ~4.88% (but no DeFi composability, no 24/7 redemption)
- BUIDL at 3.44%: ~$17,200/year (higher minimum, BlackRock counterparty)
- Aave USDC at ~3.29% APR: ~$16,450/year (variable, smart contract risk)
...
- Deploy USYC on Binance as off-exchange collateral → earn yield while trading
- Treasury allocation: split between USYC (T-bill yield, 24/7 liquidity) and Pendle PT positions (fixed higher yield, maturity-locked)

**For DeFi-native users watching this space:**
- Watch for USYC integrations in BNB Chain DeFi protocols (Pancakeswap, Venus, etc.)
- Pendle is exploring USYC pools — if/when they launch, PT USYC would give fixed T-bill yield with DeFi composability
- Track [RWA.xyz](https://app.rwa.xyz/treasuries) for real-time yield data across the category

**For anyone building a passive income stack:**
...
**If you're tracking crypto taxes across these positions:** [CoinLedger](https://coinledger.io/?fpr=4bsqmx) handles multi-chain DeFi positions including yield-bearing tokens and price-accrual mechanics. Don't try to calculate this manually in a spreadsheet — I tried, it's miserable.
...
**What is USYC and who issues it?**
USYC (US Yield Coin) is a tokenized money market fund issued by Hashnote, now a subsidiary of Circle. It invests in short-term US Treasury bills and repo agreements, with the token price appreciating daily as yield accrues.

**What APY does USYC pay?**
As of May 2026, approximately 3.93% APY (7-day annualized). APY fluctuates with Fed funds rate and T-bill market conditions. Check the official Hashnote dashboard or RWA.xyz for current rates.

**Can US retail investors buy USYC?**
No. USYC is structured as an offshore fund for non-US investors. US retail investors looking for similar T-bill yield on-chain should consider Franklin Templeton BENJI ($20 minimum, US retail).

**How is USYC different from BUIDL?**
USYC uses price accrual (your token count stays constant, price rises). BUIDL uses rebasing (price stays at $1.00, new tokens are minted as yield). USYC allows T+0 same-day USDC redemption; BUIDL settles on a different schedule. USYC is now larger by AUM ($2.9B vs $2.58B as of May 2026).

**Is Binance now accepting USYC?**
Yes. [Binance](https://www.binance.com/en/register?ref=725285686) institutional clients can hold USYC as yield-bearing off-exchange collateral for derivatives trading through Binance Banking Triparty and Ceffu custody.

**What are the risks of holding USYC?**
Key risks: Fed rate cuts reducing yield, Circle/Hashnote counterparty risk, jurisdictional regulatory changes, smart contract risk on BNB Chain deployment, and liquidity concentration in Binance's ecosystem.

**How do I track USYC yield and taxes?**
Monitor yield at RWA.xyz or CoinGecko. For tax tracking across multiple DeFi and tokenized Treasury positions, [CoinLedger](https://coinledger.io/?fpr=4bsqmx) handles price-accrual token accounting without manual entry.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is USYC and who issues it?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "USYC (US Yield Coin) is a tokenized money market fund issued by Hashnote, now a subsidiary of Circle. It invests in short-term US Treasury bills and repo agreements, with the token price appreciating daily as yield accrues."
      }
    },
    {
      "@type": "Question",
      "name": "What APY does USYC pay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "As of May 2026, approximately 3.93% APY (7-day annualized). APY fluctuates with Fed funds rate and T-bill market conditions."
      }
    },
    {
      "@type": "Question",
      "name": "Can US retail investors buy USYC?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. USYC is structured as an offshore fund for non-US investors. US retail investors looking for similar T-bill yield on-chain should consider Franklin Templeton BENJI ($20 minimum, US retail access)."
      }
    },
    {
      "@type": "Question",
      "name": "How is USYC different from BUIDL?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "USYC uses price accrual (token count stays constant, price rises daily). BUIDL uses rebasing (price stays at $1.00, new tokens are minted as yield). USYC offers T+0 same-day USDC redemption. As of May 2026, USYC is larger by AUM at approximately $2.9B vs BUIDL's $2.58B."
      }
    },
    {
      "@type": "Question",
      "name": "Is Binance now accepting USYC as collateral?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Binance institutional clients can hold USYC as yield-bearing off-exchange collateral for derivatives trading through Binance Banking Triparty and Ceffu custody."
      }
    }
  ]
}
...
**Related reading:**
- [RWA Yield On-Chain 2026: BlackRock BUIDL vs Aave USDC](/blog/rwa-yield-on-chain-buidl-vs-aave-2026)
- [Pendle Finance RWA Pools: eACRED vs mTBILL vs eEARN](/blog/pendle-finance-rwa-pools-eacred-mtbill-eearn-2026)
- [Best Stablecoin Yield After the CLARITY Act 2026](/blog/best-stablecoin-yield-after-clarity-act-2026)
- [EigenLayer Restaking Guide 2026: Dual Yield from $1K](/blog/eigenlayer-restaking-guide-2026)
- [Earn Interest on Stablecoins: Complete Guide 2026](/blog/earn-interest-stablecoins-guide-2026)
