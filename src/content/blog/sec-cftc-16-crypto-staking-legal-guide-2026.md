---
title: "SEC/CFTC Just Classified 16 Cryptocurrencies: What It Means for Your Staking"
description: "The SEC and CFTC have issued formal guidance on 16 major cryptocurrencies — including BTC, ETH, SOL, ADA, XRP, and LINK. Here's which ones you can stake legally, which face regulatory risk, and which platforms are safest to use."
pubDate: 2026-03-29
category: news
...
affiliateLinks:
  - name: "Lido"
    url: "https://lido.fi"
    cta: "Start Staking with Lido"
  - name: "Rocket Pool"
    url: "https://rocketpool.net"
    cta: "Stake with Rocket Pool"
  - name: "Coinbase Staking"
    url: "https://coinbase.com/staking"
...
With clarity on which assets are safe to stake, the next question is *where* to stake them. Three platforms dominate for compliant liquid staking: [Lido](https://lido.fi), [Rocket Pool](https://rocketpool.net), and [Coinbase Staking](https://coinbase.com/staking).

### Lido: Largest by TVL, Non-Custodial ETH and SOL Staking

[Lido](https://lido.fi) is the dominant liquid staking protocol with over $30 billion in staked ETH at its peak. You deposit ETH, receive stETH (liquid staked ETH), and earn staking rewards continuously — without locking your tokens or running a validator yourself.
...
[Rocket Pool](https://rocketpool.net) is the alternative for ETH holders who prioritize decentralization over TVL scale. It runs a permissionless node operator network where anyone can run a minipool, and depositors receive rETH (Rocket Pool's liquid staking token).
...
[Coinbase Staking](https://coinbase.com/staking) offers staking for ETH, SOL, ADA, DOT, ATOM, and several other assets — but it is fully custodial. Your assets are held by Coinbase. They operate the validators. You receive yield paid out by Coinbase.
...
- ETH ([Lido](https://lido.fi), [Rocket Pool](https://rocketpool.net), [Coinbase](https://coinbase.com/staking))
- SOL ([Lido](https://lido.fi), [Coinbase](https://coinbase.com/staking), native validator delegation)
- ADA ([Coinbase](https://coinbase.com/staking), native wallet delegation — no lockup required)

**Tier 2 — Commodity status confirmed, platform options narrower:**
- ATOM ([Coinbase](https://coinbase.com/staking), Keplr wallet native delegation)
- DOT ([Coinbase](https://coinbase.com/staking), Ledger live native staking — note 28-day unbonding)
- AVAX ([Coinbase](https://coinbase.com/staking), native delegation on Avalanche)
...
When you stake ETH via [Lido](https://lido.fi) or [Rocket Pool](https://rocketpool.net) while holding your own wallet keys, you're interacting with a protocol — not entrusting assets to a company that might be running an unregistered securities offering. This is why:

1. Native wallet delegation (ADA, ATOM, ALGO) — where you retain custody — is the cleanest option for those assets
2. Liquid staking protocols (Lido, Rocket Pool) — where the protocol is non-custodial — are preferable to centralized exchange staking for ETH and SOL
3. Custodial staking (Coinbase, Kraken, Binance) — still viable for commodity-classified assets, but carries more counterparty and regulatory exposure
